...
<div class="mx-auto container relative">
    ...
    <form class="flex flex-col gap-2" on:submit|preventDefault>
        <div class="form-control">
            ...
            <input bind:value={productData.productName} id="product-name" class="input input-bordered !h-12" placeholder="Product name"/>
        </div>
        ...
        <div class="w-full border p-4 border-base-200 flex flex-wrap gap-5">
                ...
                {#each files as f}
                    <div class="relative" >
                        ...
                        <div class="absolute top-0 right-0">
                            <input type="checkbox" class="checkbox m-4 shadow-xl shadow-primary" readonly value={false} checked={false} />
                        </div>
                    </div>
                {/each}
            {/if}
            ...
            <input multiple hidden type="file" bind:files={files} id="file-input" />
        </div>
        ...
        <div class="flex gap-2">
            <div class="form-control">
                ...
                <input bind:value={productData.productPrice} id="product-price" type="number" placeholder="Price" class="input input-bordered w-[150px]" />
            </div>
            ...
            <div class="form-control">
                ...
                <input bind:value={productData.productStock} id="product-stock" type="number" placeholder="Stock" class="input input-bordered w-[150px]" />
            </div>
        </div>
        ...
        <button on:click={createProduct} class="btn btn-primary mt-2" type="submit">{mode === "create" ? "Create" : "Update"}</button>
    </form>
