...
func (pq *ProductQuery) QuerySeller() *UserQuery {
...
func (pq *ProductQuery) WithSeller(opts ...func(*UserQuery)) *ProductQuery {
	query := (&UserClient{config: pq.config}).Query()
...
func (pq *ProductQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Product, error) {
	...
	if query := pq.withSeller; query != nil {
		if err := pq.loadSeller(ctx, query, nodes, nil,
			func(n *Product, e *User) { n.Edges.Seller = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (pq *ProductQuery) loadSeller(ctx context.Context, query *UserQuery, nodes []*Product, init func(*Product), assign func(*Product, *User)) error {
